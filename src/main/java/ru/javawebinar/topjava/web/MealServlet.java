...
//TODO 7: добавить в meals.jsp и MealServlet фильтрацию еды по дате и по времени (см. демо).
// Сброс фильтра делать не надо (реализуем через ajax в HW8).
// ВНИМАНИЕ: в приложении фильтрация делается не по интервалу дата-время, а отдельно по датам и затем отдельно по времени.